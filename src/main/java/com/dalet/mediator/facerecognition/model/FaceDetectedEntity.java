 ...
 */
@ApiModel(description = "Contains information on the detected entity which is related to this face.")
...
public class FaceDetectedEntity {
  ...
  public FaceDetectedEntity identity(String identity) {
   ...
   /**
   * Name of detected celebrity depicted by this face by a celebrity model of a person
   * @return identity
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Name of detected celebrity depicted by this face by a celebrity model of a person")
  ...
  public FaceDetectedEntity confidence(java.lang.Double confidence) {
   ...
   /**
   * Confidence that the detected identity matches this face computed by the Celebrity model
   * @return confidence
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Confidence that the detected identity matches this face computed by the Celebrity model")
  ...
  public FaceDetectedEntity detectedAt(OffsetDateTime detectedAt) {
  ...
  **/
  ...
  public FaceDetectedEntity detectedBy(String detectedBy) {
   ...
   /**
   * Name of the person or celebrity model which recognized the identity of this face
   * @return detectedBy
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Name of the person or celebrity model which recognized the identity of this face")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    FaceDetectedEntity faceDetectedEntity = (FaceDetectedEntity) o;
    return Objects.equals(this.identity, faceDetectedEntity.identity) &&
        Objects.equals(this.confidence, faceDetectedEntity.confidence) &&
        Objects.equals(this.detectedAt, faceDetectedEntity.detectedAt) &&
        Objects.equals(this.detectedBy, faceDetectedEntity.detectedBy);
  }

  @Override
  public int hashCode() {
    return Objects.hash(identity, confidence, detectedAt, detectedBy);
  }
  ...
  public String toString() {
    ...
    sb.append("class FaceDetectedEntity {\n");
