...
public class SearchFacesOutputItem {
  ...
  public SearchFacesOutputItem clusterId(String clusterId) {
   ...
   /**
   * UID of a cluster matching the input face.
   * @return clusterId
  **/
  @ApiModelProperty(example = "3f9b1898-9d9f-11ea-925a-6a51797d0d28", required = true, value = "UID of a cluster matching the input face.")
  ...
  public SearchFacesOutputItem confidence(java.lang.Double confidence) {
   ...
   * @return confidence
  **/
  @ApiModelProperty(example = "0.56", required = true, value = "confidence")
  ...
  public SearchFacesOutputItem clusterCollectionId(String clusterCollectionId) {
   ...
   /**
   * ID referring to the clusterCollectionId in which the search was executed
   * @return clusterCollectionId
  **/
  @ApiModelProperty(example = "12345", required = true, value = "ID referring to the clusterCollectionId in which the search was executed")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    SearchFacesOutputItem searchFacesOutputItem = (SearchFacesOutputItem) o;
    return Objects.equals(this.clusterId, searchFacesOutputItem.clusterId) &&
        Objects.equals(this.confidence, searchFacesOutputItem.confidence) &&
        Objects.equals(this.clusterCollectionId, searchFacesOutputItem.clusterCollectionId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(clusterId, confidence, clusterCollectionId);
  }
  ...
  public String toString() {
    ...
    sb.append("class SearchFacesOutputItem {\n");
