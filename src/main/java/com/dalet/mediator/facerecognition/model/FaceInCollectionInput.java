...
import com.dalet.mediator.facerecognition.model.FaceInCollectionInputAllOf;
 ...
 */
@ApiModel(description = "Retrieve a presigned URL providing access to a face within a face collection so that it can be downloaded.")
...
public class FaceInCollectionInput extends JobInput {
  ...
  public FaceInCollectionInput collectionId(String collectionId) {
  ...
  **/
  ...
  public FaceInCollectionInput faceIndex(String faceIndex) {
   ...
   /**
   * FaceID of the face to retrieve from the collection.
   * @return faceIndex
  **/
  @ApiModelProperty(required = true, value = "FaceID of the face to retrieve from the collection.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    FaceInCollectionInput faceInCollectionInput = (FaceInCollectionInput) o;
    return Objects.equals(this.collectionId, faceInCollectionInput.collectionId) &&
        Objects.equals(this.faceIndex, faceInCollectionInput.faceIndex) &&
        super.equals(o);
  }

  @Override
  public int hashCode() {
    return Objects.hash(collectionId, faceIndex, super.hashCode());
  }
  ...
  public String toString() {
    ...
    sb.append("class FaceInCollectionInput {\n");
