...
import com.dalet.mediator.facerecognition.model.ClusterFacesOutputAllOf;
...
public class ClusterFacesOutput extends JobOutput {
  ...
  public static final String SERIALIZED_NAME_N_CLUSTERS = "nClusters";
  @SerializedName(SERIALIZED_NAME_N_CLUSTERS)
  private java.lang.Double nClusters;


  public ClusterFacesOutput clusterCollectionId(String clusterCollectionId) {
   ...
   /**
   * UID referring to the clusterCollectionId generated or updated by the job.
   * @return clusterCollectionId
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "12345", value = "UID referring to the clusterCollectionId generated or updated by the job.")
  ...
  public ClusterFacesOutput nClusters(java.lang.Double nClusters) {
   ...
   /**
   * Number of clusters in the created or updated clusterCollection.
   * @return nClusters
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Number of clusters in the created or updated clusterCollection.")

  public java.lang.Double getnClusters() {
    return nClusters;
  }


  public void setnClusters(java.lang.Double nClusters) {
    this.nClusters = nClusters;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ClusterFacesOutput clusterFacesOutput = (ClusterFacesOutput) o;
    return Objects.equals(this.clusterCollectionId, clusterFacesOutput.clusterCollectionId) &&
        Objects.equals(this.nClusters, clusterFacesOutput.nClusters) &&
        super.equals(o);
  }

  @Override
  public int hashCode() {
    return Objects.hash(clusterCollectionId, nClusters, super.hashCode());
  }
  ...
  public String toString() {
    ...
    sb.append("class ClusterFacesOutput {\n");
