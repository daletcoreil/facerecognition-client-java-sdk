...
import com.dalet.mediator.facerecognition.model.ClusterFacesInputAllOf;
 ...
 */
@ApiModel(description = "Analyze a FaceCollection and cluster faces by semantic similarity.")
...
public class ClusterFacesInput extends JobInput {
  ...
  public static final String SERIALIZED_NAME_MINIMUM_CLUSTER_SIZE = "minimumClusterSize";
  @SerializedName(SERIALIZED_NAME_MINIMUM_CLUSTER_SIZE)
  private java.lang.Double minimumClusterSize = 2d;
  ...
  private java.lang.Double similarityThreshold = 0.5d;


  public ClusterFacesInput faceExtractionId(String faceExtractionId) {
   ...
   /**
   * ID of a FaceCollection produced by an ExtractFaces job
   * @return faceExtractionId
  **/
  @ApiModelProperty(required = true, value = "ID of a FaceCollection produced by an ExtractFaces job")
  ...
  public ClusterFacesInput clusterCollectionId(String clusterCollectionId) {
   ...
   /**
   * Optional field - if provided, cluster faces of the input collectionId into an existing clusterCollection, else create a new clusterCollection.
   * @return clusterCollectionId
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Optional field - if provided, cluster faces of the input collectionId into an existing clusterCollection, else create a new clusterCollection.")
  ...
  public ClusterFacesInput minimumClusterSize(java.lang.Double minimumClusterSize) {
   ...
   /**
   * Minimum number of images in a cluster.  Clusters with less candidates than this number will be filtered out.
   * @return minimumClusterSize
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "2", value = "Minimum number of images in a cluster.  Clusters with less candidates than this number will be filtered out.")

  public java.lang.Double getMinimumClusterSize() {
    return minimumClusterSize;
  }


  public void setMinimumClusterSize(java.lang.Double minimumClusterSize) {
    this.minimumClusterSize = minimumClusterSize;
  }


  public ClusterFacesInput similarityThreshold(java.lang.Double similarityThreshold) {
   ...
   /**
   * Similarity threshold (from 0 to 1) over which face candidates are grouped into a cluster.  Higher value produces more smaller clusters with higher confidence.
   * @return similarityThreshold
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "0.5", value = "Similarity threshold (from 0 to 1) over which face candidates are grouped into a cluster.  Higher value produces more smaller clusters with higher confidence.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ClusterFacesInput clusterFacesInput = (ClusterFacesInput) o;
    return Objects.equals(this.faceExtractionId, clusterFacesInput.faceExtractionId) &&
        Objects.equals(this.clusterCollectionId, clusterFacesInput.clusterCollectionId) &&
        Objects.equals(this.minimumClusterSize, clusterFacesInput.minimumClusterSize) &&
        Objects.equals(this.similarityThreshold, clusterFacesInput.similarityThreshold) &&
        super.equals(o);
  }

  @Override
  public int hashCode() {
    return Objects.hash(faceExtractionId, clusterCollectionId, minimumClusterSize, similarityThreshold, super.hashCode());
  }
  ...
  public String toString() {
    ...
    sb.append("class ClusterFacesInput {\n");
    ...
    sb.append("    minimumClusterSize: ").append(toIndentedString(minimumClusterSize)).append("\n");
