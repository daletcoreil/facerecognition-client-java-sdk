...
/**
 * Model tests for ClusterCollection
 */
public class ClusterCollectionTest {
    private final ClusterCollection model = new ClusterCollection();
