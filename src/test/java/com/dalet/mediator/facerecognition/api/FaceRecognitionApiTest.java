...
/**
 * API tests for FaceRecognitionApi
 */
@Ignore
public class FaceRecognitionApiTest {

    private final FaceRecognitionApi api = new FaceRecognitionApi();
     ...
     */
    @Test
    public void getClusterCollectionTest() throws ApiException {
        String projectServiceId = null;
        String uid = null;
        ClusterCollection response = api.getClusterCollection(projectServiceId, uid);
     ...
     */
    @Test
    public void getFaceTest() throws ApiException {
        String projectServiceId = null;
        String uid = null;
        Face response = api.getFace(projectServiceId, uid);
     ...
     */
    @Test
    public void getFaceExtractionCollectionTest() throws ApiException {
        String projectServiceId = null;
        String uid = null;
        FaceExtractionCollection response = api.getFaceExtractionCollection(projectServiceId, uid);
